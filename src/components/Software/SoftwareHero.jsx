...
import FloatingSkillCards from '@/components/Software/FloatingSkillCards';

const { hero } = softwareData;
    ...
    <section className="relative min-h-[55vh] grid-bg noise-bg flex items-center pt-28 pb-10 px-4 sm:px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            <p className="text-xs uppercase tracking-[0.2em] text-obsidian/40 font-medium mb-4">Engineering</p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-x-8 gap-y-6 mt-10" ref={ref}>
              {hero.stats.map((stat, i) => (
                ...
                >
                  <p className="text-3xl sm:text-4xl font-body font-bold tabular-nums tracking-tight text-indigo">
